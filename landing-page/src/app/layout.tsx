...
export default function RootLayout({
  ...
  return (
    ...
    >
      <head>
        <link rel="icon" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><rect width='100' height='100' rx='12' fill='%23e8833a'/><text y='.9em' font-size='75' x='50%' text-anchor='middle' font-family='serif' fill='white'>T</text></svg>" />
      </head>
